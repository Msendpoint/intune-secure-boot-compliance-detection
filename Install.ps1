<#
.SYNOPSIS
    One-click installer and launcher for Intune Secure Boot and OS Compliance Detection Script
...
Write-Host "    Intune Secure Boot and OS Compliance Detection Script" -ForegroundColor Cyan
...
$mainScript = Join-Path $scriptDir "scripts/intune-secure-boot-compliance-detection.ps1"
